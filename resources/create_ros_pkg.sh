...
# roscd
mkdir $ROS_WORKSPACE/${PKG_NAME}
# cd ${PKG_NAME}
mkdir $ROS_WORKSPACE/${PKG_NAME}/src
mkdir $ROS_WORKSPACE/${PKG_NAME}/launch

# create file structure
touch $ROS_WORKSPACE/${PKG_NAME}/CMakeLists.txt
touch $ROS_WORKSPACE/${PKG_NAME}/package.xml
touch $ROS_WORKSPACE/${PKG_NAME}/setup.py

# fill files with information from parameter section
echo -e $CMAKELISTS_CONTENT  > $ROS_WORKSPACE/${PKG_NAME}/CMakeLists.txt
echo -e $PACKAGE_XML_CONTENT > $ROS_WORKSPACE/${PKG_NAME}/package.xml
echo -e $SETUP_PY_CONTENT > $ROS_WORKSPACE/${PKG_NAME}/setup.py
