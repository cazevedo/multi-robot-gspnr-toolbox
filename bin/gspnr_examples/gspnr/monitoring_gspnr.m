...
%% Add Places
places = ["MonitoringL1", "MonitoringL2", "Charging",...
          "Ready", "ReadyL1", "ReadyL2",...
          "NavigatingL1ToL2", "NavigatingL2ToL1"];
tokens = [1, 1, 1,...
          0, 0, 0,...
          0, 0];
...
%% Add transitions
transitions = ["GoFromL1ToL2", "GoFromL2ToL1", "RepeatL1", "RepeatL2",...
               "GoL1", "GoL2",...
               "ArrivedL1", "ArrivedL2", "FinishedL1", "FinishedL2",...
               "Charged", "DischargedL1", "DischargedL2"];
types = ["imm", "imm", "imm", "imm",...
         "imm", "imm",...
         "exp", "exp", "exp", "exp",...
         "exp", "exp", "exp"];
rates = [0, 0, 0, 0,...
...
arc_transitions =   ["RepeatL1", "ArrivedL1","FinishedL1",...
                     "RepeatL2", "ArrivedL2","FinishedL2",...
                     "GoL1","FinishedL1","RepeatL1","GoFromL1ToL2",...
                     "GoL2","FinishedL2","RepeatL2","GoFromL2ToL1",...
                     "GoFromL1ToL2", "ArrivedL2", "DischargedL1",...
                     "GoFromL2ToL1", "ArrivedL1", "DischargedL2",...
                     "DischargedL1", "DischargedL2", "Charged",...
                     "Charged", "GoL1", "GoL2"];
